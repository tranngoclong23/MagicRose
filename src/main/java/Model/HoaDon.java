...
public class HoaDon {
    ...
    public HoaDon(int maHD, int maKH, String sdtKH, String maSP, String spDaMua, int soLuong, String thoiGianMua, String phuongThucTT, double tongTienTT, double tienDaNhan, double tienThua, String maNV) {
        this.maHD = maHD;
        this.maKH = maKH;
        this.sdtKH = sdtKH;
        this.maSP = maSP;
