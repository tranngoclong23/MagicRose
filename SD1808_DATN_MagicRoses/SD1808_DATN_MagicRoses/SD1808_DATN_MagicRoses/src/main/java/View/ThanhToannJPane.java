...
public class ThanhToannJPane extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnlThanhToan.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
...
//            }
            ...
            if (tienDaNhanStr.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập Tiền đã nhận!");
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Vui lòng nhập số hợp lệ cho Tiền đã nhận!");
                return;
            }
            if (tienDaNhan <= 0) {
            ...
            if (maNV.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập Mã nhân viên đứng quầy!");
                return;
            }
