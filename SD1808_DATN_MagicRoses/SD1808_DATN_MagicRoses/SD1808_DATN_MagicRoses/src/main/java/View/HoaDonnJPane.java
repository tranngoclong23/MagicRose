...
public class HoaDonnJPane extends javax.swing.JPanel {
    ...
    public void initTable() {
        ...
        String[] cols = new String[]{"Mã HĐ", "Mã KH", "SĐT", "SP Đã Mua", "SL", "Thời Gian", "Mã SP", "PT Thanh Toán", "Tổng Tiền", "Tiền Nhận", "Tiền Thừa", "Mã NV"};
...
//            int slTong = tinhTongSL(spDaMua);
    ...
    private void initComponents() {
        ...
        cboTimKiem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã Hóa Đơn", "SĐT Khách Hàng", "Thời Gian" }));
